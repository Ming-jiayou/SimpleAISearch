...
using SimpleAISearch.Services;
using SimpleAISearch.ViewModels.Pages;
using SimpleAISearch.ViewModels.Windows;
using SimpleAISearch.Views.Pages;
using SimpleAISearch.Views.Windows;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<AISearchViewModel>();
